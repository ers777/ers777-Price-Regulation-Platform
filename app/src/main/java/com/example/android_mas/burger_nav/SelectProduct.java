...
import com.example.android_mas.databinding.SelectProductBinding;
...
public class SelectProduct extends Fragment {
    ...
    private SelectProductBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = SelectProductBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.selectProductseacrimgbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filterProducts(binding.selectProductseacrimg.getText().toString());
            }
        });

        binding.selectProductseacrimg.addTextChangedListener(new TextWatcher() {
            @Override
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot productSnapshot : snapshot.getChildren()) {
                            ...
                            // Загружаем данные профиля продавца и имя
        ...
        FirebaseDatabase.getInstance().getReference()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot sellerSnapshot) {
                        ...
                        binding.selectProductRv.setLayoutManager(new LinearLayoutManager(getContext()));
                        binding.selectProductRv.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
                        adapter = new SelectedProductAdapter(filteredProducts);
                        binding.selectProductRv.setAdapter(adapter);
