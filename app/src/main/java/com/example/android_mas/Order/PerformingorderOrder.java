...
import com.example.android_mas.databinding.ActivityPerformingorderOrderBinding;
import com.example.android_mas.products.PerformingorderAdapter;
...
public class PerformingorderOrder extends Fragment {

    private ActivityPerformingorderOrderBinding binding;
    private PerformingorderAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = ActivityPerformingorderOrderBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.PerformingOrderRv.setLayoutManager(new LinearLayoutManager(getContext()));
        binding.PerformingOrderRv.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
        adapter = new PerformingorderAdapter(filteredProducts, "", ""); // Initialize with empty kg and price for now
        binding.PerformingOrderRv.setAdapter(adapter);

        loadPerformingOrders();

        binding.PerformingOrderSeacrimgbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                filterOrders(binding.PerformingOrderSeacrimg.getText().toString());
            }
        });

        binding.PerformingOrderSeacrimg.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    private void loadPerformingOrders() {
        FirebaseDatabase.getInstance().getReference()
                .child("Users")
                .child(currentUserUid)
                .child("performingorder")
        ...
        FirebaseDatabase.getInstance().getReference()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot sellerSnapshot) {
                        ...
                        adapter = new PerformingorderAdapter(filteredProducts, kg, price); // Initialize with empty kg and price for now
                        binding.PerformingOrderRv.setAdapter(adapter);
