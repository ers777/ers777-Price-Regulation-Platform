...
import com.example.android_mas.Order.SelectOrderPage;
import com.example.android_mas.R;
import com.google.firebase.auth.FirebaseAuth;

import java.util.ArrayList;

public class SelectOrderAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    private ArrayList<Product> products;
    private String kg;
    private String price;

    public SelectOrderAdapter(ArrayList<Product> products, String kg, String price) {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(holder.itemView.getContext(), SelectOrderPage.class);
