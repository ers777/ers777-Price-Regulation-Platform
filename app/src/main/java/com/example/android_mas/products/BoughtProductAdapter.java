...
public class BoughtProductAdapter extends RecyclerView.Adapter<ProductViewHolder> {
    private ArrayList<Product> products;

    public BoughtProductAdapter(ArrayList<Product> products) {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.productprice.setText(String.valueOf(product.pricePerKg));
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent intent = new Intent(holder.itemView.getContext(), BoughtProductPage.class);
